                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 15), // Add some space between the two paragraphs
                              Text(
...
Widget buildDot(int index) {
  return Container(
    ...
    decoration: BoxDecoration(
      shape: BoxShape.circle,
      color: 1 == index ? Color.fromARGB(255, 31, 54, 47) : Color.fromARGB(255, 202, 211, 206), // Change color based on current page
    ),
  );
}